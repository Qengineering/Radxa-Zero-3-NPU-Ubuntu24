# Radxa Zero 3 NPU with Ubuntu 24.04

![Zero3GitHub](https://github.com/user-attachments/assets/0cc97d4a-10d0-49bb-b24c-671c8e3c3736)<br/><br>
...
- Download the `Radxa_Zero3_NPU_Ubuntu24.img.xz` image (3.6 GByte) from our [Sync](https://ln5.sync.com/dl/fc4ba9dd0#25zf4m5y-9sa5mdbc-jcx4jkc7-an2nj2jr) site.
- Flash the image on the SD card with the [Imager](https://www.raspberrypi.org/software/) or [balenaEtcher](https://www.balena.io/etcher/).
- Insert the SD card in your Zero 3 and enjoy.
- Username: ***radxa***
- no password: ***radxa***
